...
const Stories = ( { title, news }: StoriesProps) => {
  const splideOptions = {
    perPage: 4,
    perMove: 1,
    type: "loop",
                ...
                <div className="relative grid items-center gap-4 pb-2 rounded-lg shadow shadow-slate-200 ring-1 ring-slate-200">
                  ...
                  <div className="flex items-center justify-center px-4 w-full">
                    <a
                      ...
                      target="_blank"
                      role={"button"}
                      className="w-full bg-gradient-to-b from-slate-900 to-black shadow-md
                       shadow-black text-center text-slate-100 py-1.5 button-theme"
                    >
                      {val.btn}
                    </a>
                  </div>
