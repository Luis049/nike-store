...
const Hero = ({ heroapi: { img, title, subtitle, btntext, sociallinks, videos } }: Props) => {
  
  // console.log(heroapi)
  return (
    <>
      <div className="relative h-autoflex w-auto flex flex-col">
